...
{
    let DecryKey = CryptoJS.enc.Utf8.parse(Key);
    let IvBytes = CryptoJS.enc.Utf8.parse(Iv);
    let DescryPtClass = CryptoJS.AES.decrypt(params,DecryKey,
        {
            iv:IvBytes,
            mode:CryptoJS.mode.CBC,
            padding:CryptoJS.pad.NoPadding
        })
    let DescryptString = DescryPtClass.toString(CryptoJS.enc.Utf8);
    return DescryptString;
}
function GetPublicKey()
{
    var PublickKeyStr;
    var GetPublicKeyUrl = "https://ios.xbiao.com/apps/Xbiao/ios-Xbiao-7_6-iPhone8_1-750_1334/user/publicKey"
    var RequestPar = 
        {
            url:GetPublicKeyUrl,
            method:"GET"
